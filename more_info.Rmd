...
This data is provided by the New York State Division of Criminal Justice Services. This annually updated dataset collects information on seven crimes classified as Index crimes ^[“Index, Violent, Property, and Firearm Rates By County: Beginning 1990.” State University of New York (SUNY) Campus Locations with Websites, Enrollment and Select Program Offerings | Open Data NY, DATA.NY.GOV, 25 Nov. 2018, data.ny.gov/Public-Safety/Index-Violent-Property-and-Firearm-Rates-By-County/34dd-6g2j.]. The two category of crimes are **violent crimes** (murder/non-negligent manslaughter, forcible rape, robbery, aggravated assault) and **property crimes** (burglary, larceny, motor vehicle theft).


## Comparison of 2000 and 2010 Populations by Race and Ethnicity
This data is obtained from the New York State Department of Labor, which sources its information from the 2000 and 2010 Census. The data compares the New York State, Regional, and County Populations by Race and Ethnicity (in this case, percentage of White, Black, Asian, Hispanic). 

## Quarterly Census of Employment and Wages Annual Data: Beginning 2000
This data is collected from the Quarterly Census of Employment and Wages program, a cooperative program with the U.S. Bureau of Labor Statistics. This data is the most complete census of employees and their wages in industry, state, regional and county levels ^[“Quarterly Census of Employment and Wages Annual Data: Beginning 2000.” State University of New York (SUNY) Campus Locations with Websites, Enrollment and Select Program Offerings | Open Data NY, DATA.NY.GOV, 14 Nov. 2018, data.ny.gov/Economic-Development/Quarterly-Census-of-Employment-and-Wages-Annual-Da/shc7-xcbw.]. 
...
In 2017, 8 of 10 counties with the highest population had the highest mean wage per worker, and 6 out of 10 lowest population had the lowest mean wage. Hamilton and Schuyler have the lowest population. Note that the crime range for highest population is dark-orange(5) to dark-red(7). 

The data is surprising as less affluent regions are associated with crime. However, the data demonstrate a positive association between wage and crime rates per capita. Is this association a coincidence? 
...
Population seems to be more correlated to crime than Income since the color gradient for crime rate per capita is more compact (5-7 as opposed to 4-7).


## Racial Diversity

Since population has a closer association to crime rate than income, we determined the ethnic-makeup of the 4 counties with the highest and lowest population. Note that we are assuming county ethnicity did not shift drastically from 2010 to 2017, as the Ethnicity data is obtain from the decennial 2010 census data.
...
All counties shown are predominantly white, excluding Queens, which has a relatively proportionate White to Asian population. Hamilton(1), Lewis(2), Schuyler(1), and Yates(2) have close to no racial diversity. Kings(7), New York(7), Queens(7), Suffolk(7) have much higher racial diversity.

What does this mean? This correlation could be a factor of income and not crime, as income and population are closely correlated.


# Conclusion
The scale of the 2016-17 increase in NYS crime violence is negligible in closer examination. Income, Population, and Diversity have a positive correlation with crime rate per capita. A possible explanation for this correlation could be that more densely populated counties provide more and varied types of jobs, which leads to immigration (thus, racial diversity) and large gaps between the highest and lowest wage earned. In addition, counties with denser population have higher costs of living, which leads to lower net income. Inequality of wage gaps in a large population size could engender dissention and crime.
